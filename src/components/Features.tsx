...
const features = [
  {
    ...
    description:
      "Fuses neural language models with symbolic logic to deliver rigorous, first-principles scientific reasoning — not just pattern matching.",
  },
  {
    icon: (
      <svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round">
    ...
    description:
      "Integrates your lab's own datasets, protocols, and domain expertise to provide reasoning that's deeply grounded in your specific research context.",
  },
  {
    icon: (
      <svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round">
    ...
    title: "Full Corpus Integration",
    description:
      "Access and reason over the entire scientific literature in real-time. Cross-reference findings, surface hidden connections, and validate hypotheses at scale.",
  },
  {
    icon: (
      <svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round">
    ...
    description:
      "From hypothesis generation to experimental design to validation — one integrated environment that accelerates every step of the research lifecycle.",
  },
  {
    icon: (
      <svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round">
    ...
    title: "Science-Native Interfaces",
    description:
      "Purpose-built tools for genomics, molecular biology, and immunology — not generic AI wrappers. Every interface speaks your scientific language.",
  },
  {
    icon: (
      <svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round">
    ...
    description:
      "Every reasoning step is traceable and transparent. Full provenance tracking so you can verify, reproduce, and trust every AI-assisted insight.",
  },
];
